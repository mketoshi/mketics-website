...
export default function CookieNotice() {
  return (
    <>
      <SEO
        title="Cookie Notice | MKETICS"
        description="Read the MKETICS cookie notice explaining how cookies and similar technologies may be used to support website functionality, performance, analytics and user experience."
        path="/cookie-notice"
      />
