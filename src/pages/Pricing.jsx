...
const plans = [
  {
    ...
    icon: Rocket,
    description:
      "Perfect for startups and businesses beginning their digital transformation.",
    features: [
      "2 Users",
      "5 Projects",
      "10 AI Quotes",
...

  {
    ...
    popular: true,
    description:
      "Advanced CRM systems, automation and scalable business workflows.",
    features: [
      "5 Users",
      "20 Projects",
      "50 AI Quotes",
...

  {
    ...
    icon: Crown,
    description:
      "Enterprise-grade infrastructure, advanced analytics and dedicated support.",
    features: [
      "20 Users",
      "100 Projects",
      "500 AI Quotes",
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 app-muted">
              AI proposals, enterprise CRM, client portals, invoices,
              workspace automation and SaaS infrastructure in one platform.
            </p>
          </div>
          ...
          <div className="mt-20 grid gap-8 lg:grid-cols-3">
            {plans.map((plan) => {
              ...
              return (
                <div
                  key={plan.name}
                  className={`relative overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-xl transition duration-300 hover:-translate-y-2 ${
                    plan.popular ? "scale-105 border-purple-500/40" : ""
                  }`}
                >
                  {plan.popular && (
                  ...
                  <a
                    href="/start-trial"
                    className={`mt-10 inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r ${plan.color} px-6 py-4 text-lg font-black text-white shadow-xl`}
                  >
                    Start Free Trial
          ...
          <div className="mt-24 rounded-[2.5rem] border border-white/10 bg-white/5 p-8 text-center shadow-2xl backdrop-blur-xl md:p-14">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 app-muted">
              MKETICS also provides custom software systems, networking,
              cloud architecture, CCTV infrastructure, AI automation and
