...
export default function RefundCancellationPolicy() {
  return (
    <>
      <SEO
        title="Refund & Cancellation Policy | MKETICS"
        description="Read the MKETICS refund and cancellation policy covering deposits, service cancellations, project work, digital services, third-party costs and refund conditions."
