...
export default function LegalCompliance() {
  return (
    <>
      <SEO
        title="Legal & Compliance | MKETICS"
        description="View MKETICS legal and compliance information including company registration details, B-BBEE status, website legal notices and official business information."
