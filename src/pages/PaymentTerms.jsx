...
export default function PaymentTerms() {
  return (
    <>
      <SEO
        title="Payment Terms | MKETICS"
        description="Read the MKETICS payment terms covering quotations, deposits, invoices, project payments, outstanding balances and final delivery."
        path="/payment-terms"
      />
