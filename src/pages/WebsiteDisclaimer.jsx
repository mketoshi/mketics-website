...
export default function WebsiteDisclaimer() {
  return (
    <>
      <SEO
        title="Website Disclaimer | MKETICS"
        description="Read the MKETICS website disclaimer covering website information, service descriptions, pricing references, third-party links, technical guidance and limitation of responsibility."
