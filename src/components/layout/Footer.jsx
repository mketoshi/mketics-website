...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#020B1F]">
      <section className="mx-auto grid max-w-7xl gap-10 px-5 py-14 lg:grid-cols-[1.4fr_1fr_1fr]">
        <div>
      ...
      <div className="border-t border-white/10 px-5 py-5">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 text-xs text-slate-400 md:flex-row md:items-center md:justify-between">
          <p>
          ...
          <p>
            ...
            {siteConfig.enterpriseNumber} | {siteConfig.beeStatus}
          </p>
        </div>
      </div>
    </footer>
